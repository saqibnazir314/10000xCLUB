...
function App() {
  ...
  const [feedback, setFeedback] = useState(`Click buy to mint your 10,000x PASS.`);
  const [Newcost, Setnewcost] = useState ('Price');
                ...
                blockchain.smartContract === null ? (
                  ...
                  <>
                    ...
                    <s.Container ai={"center"} jc={"center"} fd={"row"}>
                      ...
                      >
                        {claimingNft ? "CLAIMING YOUR PASS" : "MINT 10,000x CLUB PASS"}
                      </StyledButton>
                    </s.Container>
                  </>
                )}
